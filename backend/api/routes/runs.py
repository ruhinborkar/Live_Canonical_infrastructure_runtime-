...
async def run_verify():
    ...
    try:
        ...
        return {
            ...
            "validation_state_diff": result.get("validation_state_diff"),
            "recovery_state_diff": result.get("recovery_state_diff"),
            "original_truth_hash": result.get("original_truth_hash"),
            "reconstructed_truth_hash": result.get("reconstructed_truth_hash"),
